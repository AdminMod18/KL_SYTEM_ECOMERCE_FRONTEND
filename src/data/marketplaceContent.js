...
/** Estáticos en public/assets/brand (CloudFront sirve /assets/*). */
export const LOGO_SRC = '/assets/brand/kl-ecommerce-logo.png';
export const LOGO_ALT = 'KL-ECOMMERCE — logo';
export const FAVICON_SRC = '/assets/brand/favicon-32x32.png';
